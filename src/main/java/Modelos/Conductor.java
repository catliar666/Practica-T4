...
public class Conductor {
    ...
    //COMPRUEBA EL EMAIL PARA VER SI NO EXISTE UNA CUENTA CON ESE EMAIL
    public boolean comprobarEmail(String emailTeclado) {
        if ((conductor != null && conductor.getEmail().equals(emailTeclado))) {
            return true;
        } else if (conductor2 != null && conductor2.getEmail().equals(emailTeclado)) {
            return true;
        } else if (conductor3 != null && conductor3.getEmail().equals(emailTeclado)) return true;
        return false;
    }
    ...
    public Usuarios compruebaProvincia (String provinciaPaquete){
        if (conductor.getProvincia().equalsIgnoreCase(provinciaPaquete)) return conductor;
        else if (conductor2.getProvincia().equalsIgnoreCase(provinciaPaquete)) return conductor2;
        else if (conductor3.getProvincia().equalsIgnoreCase(provinciaPaquete)) return conductor3;
        return null;
    }
    ...
    public String pintaConductores() {
        String resultado = "";
        if (conductor != null) resultado += conductor.pintaConductor();
        if (conductor2 != null) resultado += conductor2.pintaConductor();
        if (conductor3 != null) resultado += conductor3.pintaConductor();
        if (resultado.equals("")) resultado = "No hay conductores para mostrar";
        return resultado;
    }
