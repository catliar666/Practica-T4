...
public class Destinatarios {
    ...
    public boolean compruebaRegistroPaquete(Paquetes paquete) {
    ...
    public Usuarios registrarPaqueteAuto(Paquetes paquete) {
        // Verificar si los correos electrónicos coinciden
        if (u1 != null) {
            if (paquete != null && paquete.getEmailDestinatario().equals(u1.getEmail())) {
    ...
    public boolean comprobarEmail(String emailTeclado) {
        if ((u1 != null && u1.getEmail().equals(emailTeclado))) {
            return true;
        } else if (u2 != null && u2.getEmail().equals(emailTeclado)) return true;
        return false;
    }
    public Usuarios comprobarEmailMensaje(String emailTeclado) {
        if ((u1 != null && u1.getEmail().equals(emailTeclado))) {
            return u1;
        } else if (u2 != null && u2.getEmail().equals(emailTeclado)) return u2;
        return null;
    }
    public boolean comprobarSeguimientoPaq(String numSeguimiento){
        if (u1 != null) {
            if (u1.getPaq2() != null && u1.getPaq2().getNumeroSeguimiento().equals(numSeguimiento)) return true;
            else if (u1.getPaq1() != null && u1.getPaq1().getNumeroSeguimiento().equals(numSeguimiento)) return true;
        } else if (u2 != null) {
         if (u2.getPaq2() != null && u2.getPaq2().getNumeroSeguimiento().equals(numSeguimiento)) return true;
            else if (u2.getPaq1() != null && u2.getPaq1().getNumeroSeguimiento().equals(numSeguimiento)) return true;
        }
        return false;
    }
    ...
    public String pintaUsuarios() {
        ...
        if (u1 != null && u2 != null) {
            return u1.getContador() + u1.infoUsuario() + "\n" + u2.getContador() + u2.infoUsuario();
        } else if (u1 != null) { return
            u1.getContador() + u1.infoUsuario();
        } else if (u2 != null) {
            return u2.getContador() + u2.infoUsuario();
        }
