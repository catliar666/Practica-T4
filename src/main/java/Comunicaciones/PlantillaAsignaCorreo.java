...
public class PlantillaAsignaCorreo {

    public static String generaPlantillaCambiaEstado(String nombre, String nombrePaquete, String numSeguimiento, String fecha, String estadoEnvio, String direccionEntrega, String localidad, String provincia){
        String fraseEstado = (estadoEnvio.equals("en reparto")) ? "¡Pronto le entregaremos su paquete!" : "¡Pronto estaremos de camino a su hogar!";
        ...
        return "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
               ...
               "\n" +
               "  \n" +
               "    <a href=\"\" target=\"_self\" style=\"padding:5px 15px;display:inline-block;color:#000000;font-size:14px;text-decoration:none\"  class=\"v-padding v-font-size v-layout-display\">\n" +
               "      Inicio\n" +
               "    </a>\n" +
               "  \n" +
               "  \n" +
               ...
               "    <p style=\"line-height: 140%;\"><strong><span style=\"background-color: #9d7cf4; line-height: 53.2px; color: #ecf0f1;\"> " + nombre
         + " te han asignado un paquete </span></strong></p>\n" +
               "  </div>\n" +
               "\n" +
               "      </td>\n" +
               "    </tr>\n" +
               ...
               "<p style=\"line-height: 140%;\">Tu paquete " + numSeguimiento + " se encuentra " + estadoEnvio + ", se entregará en " + direccionEntrega + ", " + localidad + ",(" + provincia + "), a fecha de entrega " + fecha + " y va dirigido a " + nombrePaquete + "</p>\n" +
               "  </div>\n" +
               "\n" +
               "      </td>\n" +
               "    </tr>\n" +
               ...
               "<p style=\"line-height: 140%;\">" + fraseEstado + "</p>\n" +
               "  </div>\n" +
               "\n" +
               "      </td>\n" +
               "    </tr>\n" +
